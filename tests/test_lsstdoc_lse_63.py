...
ABSTRACT = (
    ...
    "Assessment\nFramework, and defines the four levels of quality "
    ...
    "Science Requirements Document \citedsp{LPM-17}. A flow-down document "
    "will describe detailed implementation of the QA, including the "
    "algorithms.  In most cases the monitoring strategy, the development "
    "path for these tools or the algorithms are known. Related documents "
    "are: LSST System Requirements \citedsp{LSE-29}, Optimal Deployment "
    "Parameters \citeds{Document-11624}, Observatory System Specifications "
    "\citedsp{LSE-30}, Configuration Management Plan \citedsp{LPM-19}, "
    "Project Quality Assurance Plan \citedsp{LPM-55}, Software Development "
    "Plan \citedsp{LSE-16}, Camera Quality implementation Plan "
    "\citedsp{LCA-227}, System Engineering Management Plan \citedsp{LSE-17}, "
    "and the Operations Plan \citedsp{LPM-73}."
)
